...
namespace Swiftness.Security.Cryptography
{
	public partial class BlowfishTransform : ICryptoTransform
	{
		/*
		 * Note:
		 * This part of the class should ONLY contain
		 * the default permutation and substituion values.
		 * We want to keep the main class clean and readable.
		 */
		
		#region Default PArray
		internal static uint[] default_P =
		{
		...
		#region Default S-Box
		internal static uint[,] default_S =
		{
			{
